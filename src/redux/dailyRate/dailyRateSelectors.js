...
export const getDate = state => state.dailyRate.currentDate;
export const getIsLoading = state => state.dailyRate.loading;
export const getError = state => state.dailyRate.error;
